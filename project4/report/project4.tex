...
\paragraph{}
For a square lattice with periodic boundary conditions we have $2^4 = 16$ states. 
...
\begin{equation}
\langle E \rangle = \sum^M_{i=1} E_{i} \, P_{i}(\beta) = \dfrac{1}{Z} \sum^M_{i=1} E_{i} \, e^{-\beta E_{i}}
\end{equation}
